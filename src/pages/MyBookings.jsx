  ...
  return (
    <div className="max-padd-container bg-gradient-to-r from-[#fffbee] to-white py-16 pt-28">
      {bookings?.map((booking) => (
        <div key={booking._id} className="bg-white ring-1 ring-offset-slate-900/5 p-2 pr-4 mt-3 rounded-lg">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <div className="flex items-center gap-x-2">
                  <h5 className="medium-14">Huespedes:</h5>
                  <p>{booking.guests}</p>
                </div>
                <div className="flex items-center gap-x-2">
                  <h5 className="medium-14">Tarifa:</h5>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 border-t border-gray-300 pt-3">
            ...
            <div className="flex  gap-2 gap-x-3">
              <div className="flex items-center gap-x-2">
                <h5 className="medium-14">Pago:</h5>
                <div className="flex items-center gap-1">
                  ...
                  />
                  <p>{booking.isPaid ? "Pagado" : "No pagado"}</p>
                </div>
              </div>
              {!booking.isPaid && (
                <button className="btn-secondary !py-1 !text-xs rounded-sm">Pagar Ahora</button>
              )}
            </div>
          </div>
        </div>
